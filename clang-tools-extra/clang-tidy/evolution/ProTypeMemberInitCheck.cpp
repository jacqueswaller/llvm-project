...
void ProTypeMemberInitCheck::registerMatchers(MatchFinder *Finder) {
  ...
  if (!IgnoreDefaultConstructible) {
    ...
    Finder->addMatcher(
        cxxConstructorDecl(isDefinition(),
                           IsUserProvidedNonDelegatingConstructor)
            .bind("ctor"),
        this);
  }
...
void ProTypeMemberInitCheck::storeOptions(ClangTidyOptions::OptionMap &Opts) {
  ...
  Options.store(Opts, "IgnoreDefaultConstructible", IgnoreDefaultConstructible);
  Options.store(Opts, "IgnoreVars", IgnoreVars);
